...
//        //从数据库中取出当前铃声的position，无铃声返回的是-1
//        // TODO: 2022/11/7
//        int positionCR;
...
//        layoutManager.scrollToPositionWithOffset(positionCR, 100);
...
//                    "，selectedSong.getSongName" + selectedSong.getSongName());
                ...
                Uri songsUri = MyUtils.getRealUri(selectedSong.getId());
                Ringtone mRingtone = RingtoneManager.getRingtone(this, songsUri);
...
//                MyUtils.setAlarmControl(this, ringtone);
                ...
                if (position != checkedPositionBefore) {
                    ...
                    Log.i("getSongsList", "点击的是同一个item");
...
//            Uri songsUri = Uri.withAppendedPath(dataUri, "" + id);
            ...
            songsList.add(new Song(title, artist, id));
        }
        cursor.close();
